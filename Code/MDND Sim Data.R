...
for(i in seq_len(n_datasets)){
  ...
  sim_out = simulate_crushknockout(theta_pop = c(-0.002, -0.002, 30, 2), 
                                   ...
                                   sigma_pop = c(0.0001, 0.0001, 1, 0.1), #this doesnt do anything
                                   sigma_cond_side = c(0.000025, 0.000025, 0.5, 0.025),
                                   sigma_animal = c(0.0001, 0.0001, 1, 0.1),
                                   sigma_cell = c(0.0001, 0.0001, 1, 0.1),
                                   N.Cond_Side = 4, 
